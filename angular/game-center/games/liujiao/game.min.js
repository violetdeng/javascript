...
for(;;){var g=null;if("number"===typeof f&&(g=c.match(/(%d)|(%s)/))){c=c.replace(/(%d)|(%s)/,f);break}
c=(g=c.match(/%s/))?c.replace(/%s/,f):c+("    "+f);break}else c+="    "+f}
...
var cc=cc||{},ClassManager={id:0|998*Math.random(),instanceId:0|998*Math.random(),compileSuper:function(a,b,c){a=a.toString();var d=a.indexOf("("),e=a.indexOf(")"),d=a.substring(d+1,e),d=d.trim(),e=a.indexOf("{"),f=a.lastIndexOf("}");for(a=a.substring(e+1,f);-1!==a.indexOf("this._super");){var e=a.indexOf("this._super"),f=a.indexOf("(",e),g=a.indexOf(")",f),g=a.substring(f+1,g),g=(g=g.trim())?",":"";a=a.substring(0,e)+"ClassManager["+c+"]."+b+".call(this"+g+a.substring(f+1)}
...
var e=this.prototype,f=Object.create(e),g=ClassManager.getNewID();ClassManager[g]=e;var h={writable:!0,enumerable:!1,configurable:!0};f.__instanceId=null;d.id=g;h.value=g;Object.defineProperty(f,"__pid",h);d.prototype=f;h.value=d;Object.defineProperty(d.prototype,"constructor",h);this.__getters__&&(d.__getters__=cc.clone(this.__getters__));this.__setters__&&(d.__setters__=cc.clone(this.__setters__));for(var k=0,m=arguments.length;k<m;++k){var n=arguments[k],p;for(p in n){var s="function"===typeof n[p],r="function"===typeof e[p],u=a.test(n[p]);b&&s&&r&&u?(h.value=ClassManager.compileSuper(n[p],p,g),Object.defineProperty(f,p,h)):s&&r&&u?(h.value=function(a,b){return function(){var c=this._super;this._super=e[a];var d=b.apply(this,arguments);this._super=c;return d}}(p,n[p]),Object.defineProperty(f,p,h)):s?(h.value=n[p],Object.defineProperty(f,p,h)):f[p]=n[p];if(s){var t,v;if(this.__getters__&&this.__getters__[p]){var s=this.__getters__[p],w;for(w in this.__setters__)
if(this.__setters__[w]===s){v=w;break}
cc.defineGetterSetter(f,s,n[p],n[v]?n[v]:f[v],p,v)}
if(this.__setters__&&this.__setters__[p]){s=this.__setters__[p];for(w in this.__getters__)
if(this.__getters__[w]===s){t=w;break}
cc.defineGetterSetter(f,s,n[t]?n[t]:f[t],n[p],t,p)}}}}
d.extend=cc.Class.extend;d.implement=function(a){for(var b in a)f[b]=a[b]};return d}})();cc.defineGetterSetter=function(a,b,c,d,e,f){if(a.__defineGetter__)c&&a.__defineGetter__(b,c),d&&a.__defineSetter__(b,d);else if(Object.defineProperty){var g={enumerable:!1,configurable:!0};c&&(g.get=c);d&&(g.set=d);Object.defineProperty(a,b,g)}else throw Error("browser does not support getters");if(!e&&!f)
for(var g=null!=c,h=void 0!=d,k=Object.getOwnPropertyNames(a),m=0;m<k.length;m++){var n=k[m];if((a.__lookupGetter__?!a.__lookupGetter__(n):!Object.getOwnPropertyDescriptor(a,n))&&"function"===typeof a[n]){var p=a[n];if(g&&p===c&&(e=n,!h||f))break;if(h&&p===d&&(f=n,!g||e))break}}
a=a.constructor;e&&(a.__getters__||(a.__getters__={}),a.__getters__[e]=b);f&&(a.__setters__||(a.__setters__={}),a.__setters__[f]=b)};cc.clone=function(a){var b=a.constructor?new a.constructor:{},c;for(c in a){var d=a[c];b[c]="object"!==typeof d||!d||d instanceof cc.Node||d instanceof HTMLElement?d:cc.clone(d)}
...
if(e=a.changedTouches[k]){var m;m=cc.sys.BROWSER_TYPE_FIREFOX===cc.sys.browserType?d.convertToLocationInView(e.pageX,e.pageY,b):d.convertToLocationInView(e.clientX,e.clientY,b);null!=e.identifier?(e=new cc.Touch(m.x,m.y,e.identifier),f=this.getPreTouch(e).getLocation(),e._setPrevPoint(f.x,f.y),this.setPreTouch(e)):(e=new cc.Touch(m.x,m.y),e._setPrevPoint(g.x,g.y));g.x=m.x;g.y=m.y;c.push(e)}
...
if(e=!0,g===h.MOVED&&a.onTouchMoved)a.onTouchMoved(d,c);else
if(g===h.ENDED){if(a.onTouchEnded)a.onTouchEnded(d,c);a._registered&&a._claimedTouches.splice(f,1)}else if(g===h.CANCELLED){if(a.onTouchCancelled)a.onTouchCancelled(d,c);a._registered&&a._claimedTouches.splice(f,1)}
...
for(var d=a.getChildren(),e=d.length,f=0;f<e&&(a=d[f],!this.doEnumerateRecursive(a,b,c));f++);},doEnumerate:function(a,b){var c=a.indexOf("/"),d=a,e=!1;-1!==c&&(d=a.substr(0,c),e=!0);for(var c=!1,f,g=this._children,h=g.length,k=0;k<h;k++)
if(f=g[k],-1!==f._name.indexOf(d))
if(e){if(c=f.doEnumerate(a,b))break}else
if(b(f)){c=!0;break}
...
for(a=b._children,b=0,d=a.length;b<d;b++)(e=a[b])&&e._renderCmd&&(e._renderCmd._updateDisplayColor(c),e._renderCmd._updateColor());this._dirtyFlag^=this._dirtyFlag&cc.Node._dirtyFlags.colorDirty},_updateDisplayOpacity:function(a){var b=this._node,c,d;if(this._cascadeOpacityEnabledDirty&&!b._cascadeOpacityEnabled){this._displayedOpacity=b._realOpacity;c=b._children;a=0;for(b=c.length;a<b;a++)(d=c[a])&&d._renderCmd&&d._renderCmd._updateDisplayOpacity(255);this._cascadeOpacityEnabledDirty=!1}else if(void 0===a&&(c=b._parent,a=255,c&&c._cascadeOpacityEnabled&&(a=c.getDisplayedOpacity())),this._displayedOpacity=b._realOpacity*a/255,b._cascadeOpacityEnabled)
...
if(this._dirtyFlag&cc.Node._dirtyFlags.transformDirty){var c=a._position.x,d=a._position.y,e=this._anchorPointInPoints.x,f=-e,g=this._anchorPointInPoints.y,h=-g,k=a._scaleX,m=a._scaleY,n=0.017453292519943295*a._rotationX,p=0.017453292519943295*a._rotationY;a._ignoreAnchorPointForPosition&&(c+=e,d+=g);var s=1,r=0,u=1,t=0;if(0!==a._rotationX||0!==a._rotationY)s=Math.cos(-n),r=Math.sin(-n),u=Math.cos(-p),t=Math.sin(-p);n=a._skewX||a._skewY;n||0===e&&0===g||(c+=u*f*k+ -r*h*m,d+=t*f*k+s*h*m);p=this._transform;p.a=u*k;p.b=t*k;p.c=-r*m;p.d=s*m;p.tx=c;p.ty=d;n&&(p=cc.affineTransformConcat({a:1,b:Math.tan(cc.degreesToRadians(a._skewY)),c:Math.tan(cc.degreesToRadians(a._skewX)),d:1,tx:0,ty:0},p),0!==e||0!==g)&&(p=cc.affineTransformTranslate(p,f,h));a._additionalTransformDirty&&(p=cc.affineTransformConcat(p,a._additionalTransform),a._additionalTransformDirty=!1);this._transform=p}
...
this.dirty=!0},removeQuadsAtIndex:function(a,b){cc.assert(a+b<=this._totalQuads,cc._LogInfos.TextureAtlas_removeQuadsAtIndex);this._totalQuads-=b;if(a!==this._totalQuads){var c=cc.V3F_C4B_T2F_Quad.BYTES_PER_ELEMENT,d=(a+b)*c,e=a*c;this._quadsReader.set(this._quadsReader.subarray(d,d+(this._totalQuads-a)*c),e)}
...
if(a instanceof cc.Texture2D)this.initWithTexture(a,b,c);else
...
for(;c<d.length;c++)d[c].atlasIndex++;var d=a.children,e,f;if(d)
...
for(var h=0,k=f.length;h<k;h++){var m=f[h];a[m]&&cc.log(cc._LogInfos.spriteFrameCache_addSpriteFrames,m);a[m]=e}
...
for(var c=0,d=a.length;c<d;c++){var e=a[c],f=e.indexOf("\x3d"),g=e.substring(0,f),e=e.substring(f+1);e.match(this.INT_EXP)?e=parseInt(e):'"'===e[0]&&(e=e.substring(1,e.length-1));b[g]=e}
...
if(c)switch(a.browserType){case a.BROWSER_TYPE_CHROME:30>parseInt(c)&&(b[a.BROWSER_TYPE_CHROME]={multichannel:!1,webAudio:!0,auto:!1});break;case a.BROWSER_TYPE_MIUI:if(c=c.match(/\d+/g),2>c[0]||2===c[0]&&0===c[1]&&1>=c[2])b[a.BROWSER_TYPE_MIUI].auto=!1}
if(cc.sys.isMobile)cc.__audioSupport=cc.sys.os!==cc.sys.OS_IOS?b[a.browserType]||b.common:b[a.BROWSER_TYPE_SAFARI];else switch(a.browserType){case a.BROWSER_TYPE_IE:cc.__audioSupport=b[a.BROWSER_TYPE_IE];break;case a.BROWSER_TYPE_FIREFOX:cc.__audioSupport=b[a.BROWSER_TYPE_FIREFOX];break;default:cc.__audioSupport=b.common}})();cc.Audio=cc.Class.extend({volume:1,loop:!1,src:null,_touch:!1,_playing:!1,_AUDIO_TYPE:"AUDIO",_pause:!1,_buffer:null,_currentSource:null,_startTime:null,_currentTime:null,_context:null,_volume:null,_ignoreEnded:!1,_element:null,ctor:function(a,b,c){a&&(this._context=a);b&&(this._volume=b);a&&b&&(this._AUDIO_TYPE="WEBAUDIO");this.src=c},_setBufferCallback:null,setBuffer:function(a){if(a){var b=this._playing;this._AUDIO_TYPE="WEBAUDIO";this._buffer&&this._buffer!==a&&this.getPlaying()&&this.stop();this._buffer=a;b&&this.play();this._volume.gain.value=this.volume;this._setBufferCallback&&this._setBufferCallback(a)}},_setElementCallback:null,setElement:function(a){if(a){var b=this._playing;this._AUDIO_TYPE="AUDIO";this._element&&this._element!==a&&this.getPlaying()&&this.stop();this._element=a;b&&this.play();a.volume=this.volume;a.loop=this.loop;this._setElementCallback&&this._setElementCallback(a)}},play:function(a,b){this._playing=!0;this.loop=void 0===b?this.loop:b;"AUDIO"===this._AUDIO_TYPE?this._playOfAudio(a):this._playOfWebAudio(a)},getPlaying:function(){if(!this._playing)return this._playing;if("AUDIO"===this._AUDIO_TYPE){var a=this._element;return!a||this._pause||a.ended?this._playing=!1:!0}
return(a=this._currentSource)?null==a.playbackState?this._playing:this._currentTime+this._context.currentTime-this._startTime<this._currentSource.buffer.duration:!0},_playOfWebAudio:function(a){var b=this._currentSource;if(this._buffer){if(!this._pause&&b)
...
for(var c=a[b],d=0;d<a[b].length;d++)c[d].getPlaying()&&(c[d].pause(),this._pauseCache.push(c[d]))},_resumePlaying:function(){for(var a=this._pauseCache,b=0;b<a.length;b++)a[b].resume();a.length=0}};if(!d){var k=function(){var b=cc.audioEngine._currMusic;b&&!1===b._touch&&b._playing&&b.getPlaying()&&(b._touch=!0,b.play(0,b.loop),!a.replay&&cc._canvas.removeEventListener("touchstart",k))};setTimeout(function(){cc._canvas&&cc._canvas.addEventListener("touchstart",k,!1)},150)}
cc.eventManager.addCustomListener(cc.game.EVENT_HIDE,function(){cc.audioEngine._pausePlaying()});cc.eventManager.addCustomListener(cc.game.EVENT_SHOW,function(){cc.audioEngine._resumePlaying()})})(cc.__audioSupport);var res={Item0_png:"res/0.png",Item1_png:"res/1.png",Item2_png:"res/2.png",Item3_png:"res/3.png",Item4_png:"res/4.png",Item5_png:"res/5.png",Item6_png:"res/6.png",Item7_png:"res/7.png",ColorBg1_png:"res/bg/1.png",ColorBg2_png:"res/bg/2.png",ColorBg3_png:"res/bg/3.png",ColorBg4_png:"res/bg/4.png",ColorBg5_png:"res/bg/5.png",ColorBg6_png:"res/bg/6.png",ColorBg7_png:"res/bg/7.png",Shadow1_png:"res/shadow/1.png",Shadow2_png:"res/shadow/2.png",Shadow3_png:"res/shadow/3.png",Shadow4_png:"res/shadow/4.png",Shadow5_png:"res/shadow/5.png",Shadow6_png:"res/shadow/6.png",Shadow7_png:"res/shadow/7.png",Num_png:"res/num.png",Circle_png:"res/circle.png",Bomb_mp3:"res/music/bomb.mp3",Bomb_ogg:"res/music/bomb.ogg",Put_mp3:"res/music/put.mp3",Put_ogg:"res/music/put.ogg",In_mp3:"res/music/in.mp3",In_ogg:"res/music/in.ogg",GameOver_mp3:"res/music/game_over.mp3",GameOver_ogg:"res/music/game_over.ogg",IconGame_png:"res/icon_moregame.png",IconReplay_png:"res/icon_replay.png",IconFacebook_png:"res/icon_facebook.png",IconTwitter_png:"res/icon_twitter.png",Facebook_png:"res/f_share.png",ShareArrow2_png:"res/share_arrow2.png",MoreGame2_png:"res/more_game.png",PlayAgain2_png:"res/play_again.png",GameOver2_png:"res/game_over2.png",GameOver_png:"res/game_over.png",ScoreBg_png:"res/score_bg.png",JiXuBtn_png:"res/jixuyouxi.png",ChouJiangBtn_png:"res/choujianganniu.png",Share_png:"res/fenxiangyixia.png",fenxiang_png:"res/fenxiang.png",fenxiang2_png:"res/fenxiang2.png",MoreGame_png:"res/moregame.png"},g_resources=[],i;for(i in res)g_resources.push(res[i]);GameStartFlag=!1;AD_REAL_H=GameMainLayer=IOS_FLAG=null;FaceBookFlag=TwitterFlag=!1;var GameLayer=cc.Layer.extend({sprite:null,ctor:function(){this._super();this.init();this.showGameInfo();return!0},showGameInfo:function(){if(GameStartFlag)this.gameStart();else{GameStartFlag=!0;cc.director.pause();var a=new GameInfoLayer;this.addChild(a,100)}},gameStart:function(){this.playGame();},checkHost:function(){var a;a=window.location.href.substr(7,14);a=hex_md5(a);"72c4cc272fe7185382beacb7c0bb7958"!=a&&"29dee435d50bd51af98611fcd629b797"!=a&&cc.director.pause()},initFacebookSDK:function(){},size:null,init:function(){this.size=cc.director.getVisibleSize();this.initSystem();this.initBottomEdgeY();this.initBg();this.initCircleItem();this.initScore()},bottomEdgeY:null,AD_H:55,initBottomEdgeY:function(){if(IOS_FLAG){var a=navigator.userAgent.toLowerCase();0<a.indexOf("twitter")&&(this.AD_H+=107,document.getElementById("googleads").style.bottom="107px",TwitterFlag=!0);0<a.indexOf("fbios")&&(this.AD_H+=107,document.getElementById("googleads").style.bottom="107px",FaceBookFlag=!0)}
var a=cc.view.getFrameSize(),b=this.size;this.bottomEdgeY=a=this.AD_H*(PC_FLAG?b.height/a.height:b.width/a.width);b=new cc.DrawNode;b.drawRect(cc.p(0,0),cc.p(this.size.width,a-2),cc.color("#000000"),2,cc.color("#ffffff"));var c=new cc.Sprite;this.addChild(c,15);c.addChild(b,15);AD_REAL_H=a},initSystem:function(){var a=cc.sys;IOS_FLAG=a.os===a.OS_IOS||a.os===a.OS_OSX?!0:!1},initBg:function(){var a=new cc.LayerColor(cc.color("#1c1c1c"));this.addChild(a);this.initBgCircle();this.initBgItem()},tileObj:null,itemW:77,itemH:87,itemSubH:null,itemDisX:null,itemDisY:null,centerP:null,initBgItem:function(){this.tileObj={};this.itemSubH=Math.tan(30*Math.PI/180)*(this.itemW/2);var a=cc.p(this.size.width/2,this.size.height/2);a.y=this.size.height-(this.size.height-(this.circle.y+this.circle.height/2+50))/2;this.centerP=a;var b=this.itemH-this.itemSubH+12;this.itemDisX=this.itemW+
8.5;this.itemDisY=b;for(var a=cc.p(a.x,a.y-3*b),c,d,e,f=-3,g=4,h=0;7>h;h++){d=a.y+h*b;e=2* -Math.floor(g/2);0==h%2?(c=(this.itemW+8.5)/2,e+=1):c=0;c=a.x-Math.floor(g/2)*(this.itemW+8.5)+c;for(var k=0;k<g;k++){var m=this.getItem(0);this.addChild(m);m.x=c+k*(this.itemW+8.5);m.y=d;var n=(e+2*k).toString(),p=f.toString();this.tileObj[n]||(this.tileObj[n]={});this.tileObj[n][p]={};this.tileObj[n][p].bgItem=m;m.logicX=n;m.logicY=p}
3>h?g++:g--;f++}},circle:null,circleP:null,initBgCircle:function(){var a=new cc.Sprite(res.Circle_png);this.addChild(a,1);this.circle=a;a.x=this.size.width/2;a.y=this.bottomEdgeY+a.height/2+5;a.opacity=180;this.circleP=a.getPosition()},getItem:function(a){null==a&&(a=this.getItemRandomColor());var b=new cc.Sprite("res/"+a+".png");b.colorId=a.toString();0!=a&&this.createBgItemColor(b,b.colorId);return b},getItemRandomColor:function(){var a=this.curMaxPoint+1;if(7<=a){if(0.03>=Math.random())return cc.log(" in 0.01 _____ "),7;a=6}
var b=Number(Math.ceil((100-7*a)/this.curTotalPoint*100)/100);cc.log("------------");cc.log("rate: "+b);for(var c=[],d=a;0<d;d--){var e=7+b*d;cc.log("value: "+e);c.push(e)}
d=Math.floor(100*Math.random());cc.log("randomNum : "+d);for(b=e=0;b<d;){b+=c[e];console.log(b,c[e],e);if(b>=d)return cc.log("index + 1 : "+(e+1)),e+1;e++}
cc.log(" no index .. ");a=Math.ceil(Math.random()*a);8<=a&&(a=7);return a},circleItem:null,initCircleItem:function(a,b){this.circleItem&&this.circleItem.removeFromParent();var c=this.getCircleItem(b);c.setPosition(this.circleP);this.circleItem=c;if(a){c.scale=0.2;var d=cc.sequence(cc.scaleTo(0.08,1),cc.callFunc(function(a,b){b.canTouch=!0},this,this));c.runAction(d)}},getCircleItem:function(a){var b=new cc.Sprite;this.addChild(b,2);if(4==a||!a&&0.05>Math.random())return a=this.getItem(),b.addChild(a,2),b.itemArr=[a],a.offX=a.x,a.offY=a.y,b;var c;c=a?a:Math.ceil(3*Math.random());a=this.getItem();var d=this.getItem();b.addChild(a,2);b.addChild(d,2);b.itemArr=[a,d];switch(c){case 1:a.x=this.itemDisX/4;a.y=this.itemDisY/2;d.x=-this.itemDisX/4;d.y=-this.itemDisY/2;break;case 2:a.x=this.itemDisX/2;a.y=0;d.x=-this.itemDisX/2;d.y=0;break;case 3:a.x=this.itemDisX/4,a.y=-this.itemDisY/2,d.x=-this.itemDisX/4,d.y=this.itemDisY/2}
a.offX=a.x;a.offY=a.y;d.offX=d.x;d.offY=d.y;return b},scoreTf:null,score:0,initScore:function(){var a=new cc.LabelAtlas("0",res.Num_png,43,42,"0");this.addChild(a);a.attr({x:this.size.width/2,y:this.circle.y+this.circle.height/2+10,anchorX:0.5,anchorY:0});this.scoreTf=a},addScore1:function(a){this.score+=a;this.scoreTf.string=this.score.toString()},refreshTitle:function(){this.title.x=this.scoreTf.x-this.scoreTf.width-30},playScoreTarget:0,playScore:0,playSubScore:0,addScore:function(a){this.playScoreTarget=this.score+a;this.score+=a;this.scoreTf.string=this.playScore.toString();this.playSubScore=Math.ceil((this.playScoreTarget-this.playScore)/20);this.schedule(this.scoreUpdateFunc,0.05)},scoreUpdateFunc:function(){this.playScore+=this.playSubScore;this.playScore>=this.playScoreTarget?(this.unschedule(this.scoreUpdateFunc),this.scoreTf.string=this.score.toString()):this.scoreTf.string=this.playScore.toString()},showScore:function(a,b){var c=a.getPosition(),d=new cc.LabelTTF("+"+b.toString(),null,60);d.setPosition(c);d.setColor(cc.color("#ffffff"));d.setAnchorPoint(cc.p(0.5,0.5));d.enableShadow(cc.color("#000000"),cc.size(3,-3),1);this.addChild(d,5);c=cc.sequence(cc.moveBy(0.4,cc.p(0,100)).easing(cc.easeCircleActionOut()),cc.spawn(cc.moveBy(0.4,cc.p(0,-100)).easing(cc.easeCircleActionIn()),cc.fadeOut(0.4).easing(cc.easeCircleActionIn())),cc.callFunc(function(a,b){a.removeFromParent()},this,this));d.runAction(c)},playGame:function(){this.createListener();this.scheduleUpdate()},update:function(a){this.updateCircle()},circleSpeed:1,updateCircle:function(){this.circle.rotation+=this.circleSpeed;360<=this.circle.rotation&&(this.circle.rotation-=360)},createListener:function(){cc.eventManager.addListener({event:cc.EventListener.TOUCH_ONE_BY_ONE,swallowTouches:!0,onTouchBegan:this.onTouchBegan,onTouchMoved:this.onTouchMoved,onTouchEnded:this.onTouchEnded,onTouchCancelled:this.onTouchEnded},this)},canTouch:!0,onTouchBegan:function(a,b){var c=b.getCurrentTarget();if(a.getLocation().y<c.bottomEdgeY)return document.documentElement.scrollTop=document.body.scrollTop=0,!1;if(c.canTouch&&!c.gameEndFlag&&!c.touchMoveFlag)return c.touchBegan(a,b),!0},onTouchMoved:function(a,b){b.getCurrentTarget().touchMove(a,b)},onTouchEnded:function(a,b){b.getCurrentTarget().touchEnd(a,b)},touchedFlag:!1,startTouchP:null,oldLocation:null,canPutFlag:!1,curPieceArr:null,curItemIndex:null,touchBegan:function(a,b){this.canPutFlag=!1;var c=a.getLocation();this.startTouchP=this.oldLocation=c;this.touchedFlag=c.y<=this.circle.y+this.circle.height/2?!0:!1},touchMoveFlag:!1,moveOffYLen:120,touchMove:function(a,b){if(this.touchedFlag){var c=a.getLocation();if(this.touchMoveFlag||!(15>=cc.pDistance(this.startTouchP,c))){if(this.touchMoveFlag){var d=this.oldLocation,e=c.x-d.x,d=c.y-d.y;this.oldLocation=c;this.circleItem.x+=e;this.circleItem.y+=d}else this.touchMoveFlag=!0,c.y+=this.moveOffYLen,this.circleItem.runAction(cc.moveBy(0.05,cc.p(0,this.moveOffYLen)));this.checkCanPut()}}},drawTest:function(a){for(var b=this.circleItem.itemArr,c=0;c<b.length;c++){var d=new cc.DrawNode;a=cc.p(b[c].offX,b[c].offY);a.x+=this.circleItem.x;a.y+=this.circleItem.y;d.drawDot(a,10,cc.color("#aa0000"));this.addChild(d,10)}},touchEnd:function(){this.touchedFlag?this.touchMoveFlag?(this.touchMoveFlag=!1,this.hideOldLightTiles(),this.canPutFlag?this.putTile():this.backOldPosition()):this.curRectRotation():this.touchMoveFlag=!1},putTile:function(){this.canTouch=!1;for(var a=this.oldLightTiles,b=0;b<a.length;b++){var c=a[b].bgItem.item;c.removeFromParent();this.addChild(c,2);c.setPosition(c.colorBgItem.getPosition());c.logicX=a[b].bgItem.logicX;c.logicY=a[b].bgItem.logicY;c.colorBgItem.removeFromParent();a[b].buildingFlag=!0;a[b].building=c}
SoundUtile.playMusic("res/music/put");this.checkCanPop()},oldLightTiles:null,canPutFlag:null,checkCanPut:function(){for(var a=this.circleItem.itemArr,b=this.tileObj,c=[],d,e=0;e<a.length;e++){d=!1;var f=cc.p(a[e].offX,a[e].offY);f.x+=this.circleItem.x;f.y+=this.circleItem.y;f=this.pointToTile(f);b[f.x.toString()]&&(f=b[f.x.toString()][f.y.toString()])&&!f.buildingFlag&&(c.push(f),f.bgItem.item=a[e],d=!0);if(!d)break}
this.hideOldLightTiles();if(d){for(e=0;e<c.length;e++)this.showBgItemColor(c[e].bgItem,c[e].bgItem.item);this.oldLightTiles=c}
this.canPutFlag=d},checkGameEnd:function(){function a(a){if(d[targetLogicX]&&d[targetLogicX][targetLogicY]){var e=d[targetLogicX][targetLogicY];e.checkEndFlag||e.building||(e.checkEndFlag=!0,c[a]||(c[a]=!0,b.push(Number(a))))}}
var b=[],c={},d=this.tileObj,e,f,g;for(g in d){var h=d[g],k;for(k in h)
...
0).toString(),a("2"),targetLogicX=(Number(e)-1).toString(),targetLogicY=(Number(f)+1).toString(),a("3"),targetLogicX=(Number(e)+1).toString(),targetLogicY=(Number(f)-1).toString(),a("3")),4<=b.length)break;if(4<=b.length)break}
for(g in d)
for(k in h=d[g],h)h[k].checkEndFlag=!1;if(0>=b.length)this.gameEnd();else{var m;4>b.length&&(e=Math.floor(Math.random()*b.length),m=b[e]);this.initCircleItem(!0,m)}},cleanFlag:function(){var a=this.tileObj,b;for(b in a){var c=a[b],d;for(d in c){var e=c[d];e.checkedFlag=!1;e.building&&(e.building.moveSpeed=0,e.building.moveTarget=null)}}
this.popArr=[];this.popTotalArr=[]},pointToTile:function(a){var b=this.itemDisY,c=Math.round((a.x-this.centerP.x)/(this.itemDisX/2));a=Math.round((a.y-this.centerP.y)/b);return cc.p(c,a)},tileToPoint:function(a,b){return cc.p(this.itemDisX/2*a+this.centerP.x,b*this.itemDisY+this.centerP.y)},showBgItemColor:function(a,b){var c=b.colorBgItem;c.setPosition(a.getPosition());c.setVisible(!0)},createBgItemColor:function(a,b){var c=this.getColorBgItem(b);c.setVisible(!1);a.colorBgItem=c},bgColorObj:null,getColorBgItem:function(a){a=new cc.Sprite("res/bg/"+a+".png");this.addChild(a,1);a.opacity=130;return a},hideOldLightTiles:function(){for(var a=this.circleItem.itemArr,b=0;b<a.length;b++)a[b].colorBgItem.setVisible(!1)},backOldPosition:function(){this.circleItem.stopAllActions();this.canTouch=!1;var a=new cc.Sequence(cc.moveTo(0.1,this.circleP),cc.callFunc(function(a,c){c.canTouch=!0},this,this));this.circleItem.runAction(a)},curRectRotation:function(){var a=new cc.Sequence(cc.rotateBy(0.15,180),cc.callFunc(function(a,c){c.changeCircleItemP();c.canTouch=!0},this,this));this.circleItem.setPosition(this.circleP);this.canTouch=!1;this.circleItem.runAction(a)},changeCircleItemP:function(){for(var a=this.circleItem.itemArr,b=0;b<a.length;b++)a[b].offX*=-1,a[b].offY*=-1},popTotalArr:null,popArr:null,SPEED_LEN:0.2,checkCanPop:function(){function a(a,b){a.removeFromParent();b.tileObj[a.logicX][a.logicY].buildingFlag=!1;b.tileObj[a.logicX][a.logicY].building=null}
this.popTotalArr=[];this.cleanFlag();this.moveEndCount=0;var b=this.oldLightTiles;this.sortOldTileArr();for(var c=0;c<b.length;c++){var d=b[c].building;d.moveSpeed&&0!=d.moveSpeed||(d.moveSpeed=0,this.popArr=[d],this.checkOneItemCanPop(b[c]),3<=this.popArr.length&&this.popTotalArr.push(this.popArr))}
if(0<this.popTotalArr.length)
for(c=0;c<this.popTotalArr.length;c++){b=this.popTotalArr[c];b.sort(function(a,b){return b.moveSpeed-a.moveSpeed});for(var e=0;e<b.length;e++)
if(d=b[e],d.setLocalZOrder(2+
e),0<d.moveSpeed){var f=this.SPEED_LEN/d.moveSpeed,g=this.tileToPoint(d.moveTarget.logicX,d.moveTarget.logicY),f=cc.sequence(cc.moveTo(f,g),cc.callFunc(function(b,c){if(b.moveTarget.moveTarget){var d=this.tileToPoint(b.moveTarget.moveTarget.logicX,b.moveTarget.moveTarget.logicY),d=cc.sequence(cc.moveTo(this.SPEED_LEN/b.moveSpeed,d),cc.callFunc(function(b,c){a(b,c)},c,c));b.runAction(d)}else a(b,c)},this,this));d.runAction(f);1==d.moveSpeed&&this.addShadowAnimation(d)}else f=cc.sequence(cc.delayTime(this.SPEED_LEN),cc.callFunc(this.oneMoveEnd,this,this)),d.runAction(f),d.eatCount=b.length}else this.checkGameEnd()},addShadowAnimation:function(a){var b=a.getPosition(),c=a.moveTarget.getPosition(),c=MyUtil.getAngleByPoints(b,c),b=new cc.Sprite("res/shadow/"+a.colorId+".png");this.addChild(b);b.x=a.x;b.y=a.y;c*=-1;a.x<a.moveTarget.x&&(c+=180);var d=a.moveTarget.x-a.x;a=a.moveTarget.y-a.y;b.rotation=c;a=cc.sequence(cc.delayTime(this.SPEED_LEN/4),cc.spawn(cc.moveBy(0.2,cc.p(d/2,a/2))),cc.callFunc(function(a,b){a.removeFromParent()},this,this));b.runAction(a)},moveEndCount:0,oneMoveEnd:function(a,b){b.addItemPoint(a);var c=Number(a.colorId)*a.eatCount;b.addScore(c);b.showScore(a,c);b.moveEndCount++;b.moveEndCount>=b.popTotalArr.length&&(c=b.bombItem?cc.sequence(cc.delayTime(0.1),cc.callFunc(function(a,b){b.bombStart()},b,b)):cc.sequence(cc.delayTime(b.changePointTime),cc.callFunc(function(a,b){b.moveEnd()},b,b)),b.runAction(c))},bombPopArr:null,bombStart:function(){function a(){if(e[targetLogicX]&&e[targetLogicX][targetLogicY]){var a=e[targetLogicX][targetLogicY];a.building&&d.push(a.building)}}
function b(a,b){var c=0.24;b==g.bombItem?(c=cc.sequence(cc.moveBy(c/6,cc.p(-3,3)),cc.moveBy(c/6,cc.p(6,-6)),cc.moveBy(c/6,cc.p(-6,0)),cc.moveBy(c/6,cc.p(6,6)),cc.moveBy(c/6,cc.p(-6,-3)),cc.moveBy(c/6,cc.p(3,0)),cc.delayTime(0.15)),c=cc.sequence(cc.delayTime(a),c,cc.callFunc(function(){SoundUtile.playMusic("res/music/bomb")},g,g),cc.spawn(cc.fadeOut(0.4).easing(cc.easeExponentialOut()),cc.scaleTo(0.4,3).easing(cc.easeExponentialOut())),cc.callFunc(g.bombEnd,g,g))):c=cc.sequence(cc.delayTime(a+(c+0.15)),cc.callFunc(function(a,b){var c=Number(a.colorId);b.addScore(c);b.showScore(a,c)},g,g),cc.spawn(cc.fadeOut(0.4).easing(cc.easeExponentialOut()),cc.scaleTo(0.4,3).easing(cc.easeExponentialOut())),cc.callFunc(g.bombEnd,g,g));b.runAction(c)}
var c=this.bombItem;this.bombPopArr=[c];this.bombCount=0;var d=this.bombPopArr,e=this.tileObj,f=c.logicX,c=c.logicY,g=this;targetLogicX=(Number(f)-2).toString();targetLogicY=c.toString();a();targetLogicX=(Number(f)-1).toString();targetLogicY=(Number(c)+1).toString();a();targetLogicX=(Number(f)+1).toString();targetLogicY=(Number(c)+1).toString();a();targetLogicX=(Number(f)+2).toString();targetLogicY=(Number(c)+0).toString();a();targetLogicX=(Number(f)+1).toString();targetLogicY=(Number(c)-1).toString();a();targetLogicX=(Number(f)-1).toString();targetLogicY=(Number(c)-1).toString();a();b(0,d[0]);if(0<d.length)
for(f=1;f<d.length;f++)b(0.12,d[f]);this.showBombParticle()},showBombParticle:function(){},bombCount:0,bombEnd:function(a,b){this.bombCount++;var c=b.tileObj;c[a.logicX][a.logicY].buildingFlag=!1;c[a.logicX][a.logicY].building=null;a.removeFromParent();b.bombCount>=b.bombPopArr.length&&(b.bombItem=null,b.checkGameEnd())},curMaxPoint:1,curTotalPoint:3,changePointTime:0.25,addItemPoint:function(a){var b=Number(a.colorId)+1,c=b.toString();SoundUtile.playMusic("res/music/in");if(8<=b)this.bombItem=a;else{if(b>this.curMaxPoint){this.curMaxPoint=b;var d=0;6<b&&(b=6);for(var e=1;e<=b;e++)d+=e;this.curTotalPoint=d}
a.setLocalZOrder(1);d=new cc.Sprite("res/"+c+".png");this.addChild(d,1);d.opacity=0;d.x=a.x;d.y=a.y;d.logicX=a.logicX;d.logicY=a.logicY;d.colorId=c;this.tileObj[d.logicX][d.logicY].building=d;d.oldItem=a;a=cc.sequence(cc.fadeIn(this.changePointTime),cc.callFunc(function(a,b){a.oldItem.removeFromParent();a.olditem=null},this,this));d.runAction(a)}},moveEnd:function(){for(var a=this.oldLightTiles,b=0;b<a.length;b++)a[b]&&!a[b].buildingFlag&&(a.splice(b,1),b--);this.checkCanPop()},checkOneItemCanPop:function(a){function b(){if(e[f]&&e[f][g]&&(h=e[f][g],!h.checkedFlag&&h.building&&h.building.colorId==c.colorId&&-1==m.indexOf(h.building))){m.push(h.building);var a=2*c.moveSpeed;0==a&&(a=1);h.building.moveSpeed=a;h.building.moveTarget=c;k.push(h)}}
if(!a.checkedFlag){a.checkedFlag=!0;var c=a.building;a=c.logicX;var d=c.logicY,e=this.tileObj,f,g,h,k=[],m=this.popArr;f=(Number(a)-2).toString();g=d.toString();b();f=(Number(a)-1).toString();g=(Number(d)+1).toString();b();f=(Number(a)+
1).toString();g=(Number(d)+1).toString();b();f=(Number(a)+2).toString();g=(Number(d)+0).toString();b();f=(Number(a)+1).toString();g=(Number(d)-1).toString();b();f=(Number(a)-1).toString();g=(Number(d)-1).toString();b();if(0<k.length)
for(a=0;a<k.length;a++)this.checkOneItemCanPop(k[a])}},sortOldTileArr:function(){function a(){c[targetLogicX]&&c[targetLogicX][targetLogicY]&&(tmpTileData=c[targetLogicX][targetLogicY],tmpTileData.building&&tmpTileData.building.colorId==e.colorId&&e.aroundNum++)}
for(var b=this.oldLightTiles,c=this.tileObj,d=0;d<b.length;d++){var e=b[d].building;e.aroundNum=0;var f=e.logicX,g=e.logicY;targetLogicX=(Number(f)-2).toString();targetLogicY=g.toString();a();targetLogicX=(Number(f)-1).toString();targetLogicY=(Number(g)+1).toString();a();targetLogicX=(Number(f)+1).toString();targetLogicY=(Number(g)+1).toString();a();targetLogicX=(Number(f)+2).toString();targetLogicY=(Number(g)+0).toString();a();targetLogicX=(Number(f)+1).toString();targetLogicY=(Number(g)-1).toString();a();targetLogicX=(Number(f)-1).toString();targetLogicY=(Number(g)-1).toString();a()}
b.sort(function(a,b){var c=a.building,d=b.building;return c.aroundNum==d.aroundNum?c.x!=d.x?c.x-d.x:c.y-d.y:d.aroundNum-c.aroundNum})},level:0,levelCurCount:0,levelTargetCount:15,levelUp:function(){this.level++},gameEndFlag:!1,gameEnd:function(){this.gameEndFlag=!0;this.unscheduleUpdate();cc.log("gameEnd");SoundUtile.playMusic("res/music/game_over");var a=new cc.Sprite(ChineseFlag?res.GameOver_png:res.GameOver2_png);this.addChild(a,19);a.attr({x:this.size.width/2,y:this.size.height/2-20+this.bottomEdgeY,opacity:0});var b=new cc.Sequence(cc.moveBy(1,cc.p(0,-20)).easing(cc.easeCubicActionOut()),cc.delayTime(0.7),cc.callFunc(this.gameEndCallBack,this,this));a.runAction(cc.fadeIn(0.8));a.runAction(b)},gameEndCallBack:function(a,b){b.gameEnd1()},gameEnd1:function(){cc.director.pause();this.unscheduleUpdate();var a=ChineseFlag?new GameEndLayer2:new EndLayerEnglish;this.endLayer=a;this.addChild(a,25);this.setGameScore()},setGameScore:function(){var a=this.score,b=cc.sys.localStorage.getItem("p79_score");b||(b=a);a>b;a>=b&&(b=a,cc.sys.localStorage.setItem("p79_score",b));this.endLayer.SetMaxScore(b);this.endLayer.showScore(a)},gameLose:function(){ChineseFlag&&(this.endLayer.SetTipLabel("\u83b7\u5f97\u5956\u54c1\u8fd8\u6709\u4e00\u6b65\u4e4b\u9065\uff01"))}}),MyUtil={getAngleByPoints:function(a,b){return 360*Math.atan((b.y-a.y)/(b.x-a.x))/(2*Math.PI)},getAngle:function(a,b,c,d){a=Math.abs(a-c);b=Math.abs(b-d);d=Math.sqrt(Math.pow(a,2)+Math.pow(b,2));b=Math.acos(b/d);return 180/(Math.PI/b)},getPointByCPAndAngleAndLen:function(a,b,c){var d=b*Math.PI/180;b=c*Math.cos(d);c*=Math.sin(d);return cc.p(a.x+c,a.y+b)}};SoundUtile={playMusic:function(a){IOS_FLAG?cc.audioEngine.playEffect(a+".mp3",!1):(a+=".ogg",cc.audioEngine.playMusic(a,!1))}};var GameScene=cc.Scene.extend({onEnter:function(){this._super();var a=new GameLayer;this.addChild(a)}});var EndLayer=cc.Layer.extend({tipLabel:null,chouJiangItem:null,moreGameItem:null,_shareLabel:null,ctor:function(a){this._super();a=cc.director.getVisibleSize();var b=new cc.DrawNode;this.addChild(b);b.clear();b.ctor();b.drawRect(cc.p(0,0),cc.p(a.width,a.height),cc.color(0,0,0,200),1,cc.color(0,0,0,255));this._shareLabel=new cc.Sprite.create(res.fenxiang_png);this._shareLabel.setAnchorPoint(1,1);this._shareLabel.x=a.width-25;this._shareLabel.y=a.height-20;this._shareLabel.setVisible(!1);this.addChild(this._shareLabel);this.tipLabel=new cc.LabelTTF("\u6210\u7ee9\u4e0d\u9519\uff0c\u8bd5\u8bd5\u624b\u6c14\uff01","Arial",45);this.tipLabel.x=a.width/2;this.tipLabel.y=a.height/2-45;this.addChild(this.tipLabel);b=new cc.MenuItemImage(res.JiXuBtn_png,res.JiXuBtn_png,function(){cc.log("JiXuBtn is clicked!");cc.director.runScene(new GameScene);cc.director.resume()},this);b.attr({x:a.width/2-150,y:a.height/5,anchorX:0.5,anchorY:0.5});var c=new cc.MenuItemSprite(new cc.Sprite(res.Share_png),new cc.Sprite(res.Share_png),function(){this._shareLabel.setVisible(!0)},this);c.attr({x:a.width/2+150,y:a.height/5,anchorX:0.5,anchorY:0.5});this.moreGameItem=new cc.MenuItemImage(res.MoreGame_png,res.MoreGame_png,function(){console.log(11)},this);this.moreGameItem.attr({x:a.width/2,y:a.height/2-150,anchorX:0.5,anchorY:0.5});a.x=0;a.y=0;this.addChild(a)},showScore:function(a){var b=cc.director.getVisibleSize(),c=new cc.Sprite(res.ScoreBg_png);this.addChild(c);c.attr({x:b.width/2,y:3*b.height/4+45});a=new cc.LabelTTF(a.toString(),"Arial",49);this.addChild(a);a.attr({x:b.width/2,y:3*b.height/4+45,color:cc.color("#000000")})},SetMaxScore:function(a){var b=cc.director.getVisibleSize(),c=new cc.LabelTTF("\u6700\u9ad8\u6210\u7ee9\uff1a"+a+"\u5206","Arial",45);this.addChild(c);c.attr({x:b.width/2,y:2*b.height/3-15});console.log("\u516d\u89d2\u62fc\u62fc\uff5e\u6211\u7684\u6700\u597d\u6210\u7ee9\uff1a"+
a+"\u5206\uff0c\u6765\u8bd5\u4e00\u4e0b\uff1f")},SetTipLabel:function(a){this.tipLabel.string=a},SetChouJiangVisible:function(a){this.chouJiangItem.setVisible(a);this.moreGameItem.setVisible(a);a||this.tipLabel.setVisible(!0);""==sys_activityID&&(this.moreGameItem.setVisible(!0),this.tipLabel.setVisible(!1))}});var EndLayerEnglish=cc.Layer.extend({tipLabel:null,chouJiangItem:null,moreGameItem:null,_shareLabel:null,size:null,ctor:function(){this._super();var a=cc.director.getVisibleSize();a.height-=AD_REAL_H;this.size=a;var b=new cc.LayerColor(cc.color(0,0,0,230));this.addChild(b);cc.log("AD_REAL_H : "+AD_REAL_H);this.tipLabel=new cc.LabelTTF("","Arial",45);this.tipLabel.setAnchorPoint(0.5,1);this.tipLabel.x=a.width/2;this.tipLabel.y=2*a.height/3-130+AD_REAL_H;this.addChild(this.tipLabel);var b=a.height/2-200+AD_REAL_H,c=new cc.MenuItemImage(res.IconGame_png,res.IconGame_png,function(){console.log("IconGame_png");},this);c.attr({x:a.width/2,y:b+80,anchorX:0.5,anchorY:0.5});c.color=cc.color("#fcf253");c.scale=0.8;c.y-=0.1*c.height;var d=new cc.MenuItemImage(res.IconFacebook_png,res.IconFacebook_png,function(){this.onFacebookClick()},this);d.attr({x:a.width/2-130,y:b-80,anchorX:0.5,anchorY:0.5});var e=new cc.MenuItemImage(res.IconReplay_png,res.IconReplay_png,function(){cc.director.runScene(new GameScene);cc.director.resume()},this);e.attr({x:a.width/2+130,y:d.y,anchorX:0.5,anchorY:0.5});var f=new cc.MenuItemImage(res.IconTwitter_png,res.IconTwitter_png,function(){this.onTwitterClick()},this);f.attr({x:a.width/2,y:d.y,anchorX:0.5,anchorY:0.5});a=new cc.Menu(f,d,e,c);a.x=0;a.y=0;this.addChild(a);a=d.x-d.width/2;e=e.x+e.width/2;d=b-1;b+=1;c=new cc.DrawNode;c.drawRect(cc.p(a,d),cc.p(e,b),cc.color("#ffffff"),0,cc.color("#ffffff"));this.addChild(c)},showScore:function(a){var b=this.size,c=new cc.Sprite(res.ScoreBg_png);this.addChild(c);c.attr({x:b.width/2,y:2*b.height/3+AD_REAL_H});a=new cc.LabelTTF(a.toString(),"Arial",80);this.addChild(a);a.attr({x:b.width/2,y:2*b.height/3+AD_REAL_H,color:cc.color("#000000")})},bestScore:0,SetMaxScore:function(a){this.bestScore=a;this.tipLabel.string="Best : "+
a;cc.log("this.tipLabel.x: "+this.tipLabel.x)},onTwitterClick:function(){console.log("onTwitterClick");},onFacebookClick:function(){console.log("onFacebookClick");},onShareSimpleLink:function(){}});var GameEndLayer2=cc.Layer.extend({tipLabel:null,chouJiangItem:null,moreGameItem:null,_shareLabel:null,ctor:function(){this._super();var a=cc.director.getVisibleSize(),b=new cc.LayerColor(cc.color(0,0,0,230));this.addChild(b);this._shareLabel=new cc.Sprite.create(res.fenxiang2_png);this._shareLabel.setAnchorPoint(1,1);this._shareLabel.x=a.width-25;this._shareLabel.y=a.height-20;this.addChild(this._shareLabel);b=new cc.LabelTTF(/*"\u5206\u4eab\u7ed9\u670b\u53cb","Arial",40*/);b.setAnchorPoint(1,0.5);b.x=a.width-this._shareLabel.getContentSize().width;b.y=a.height-this._shareLabel.getContentSize().height/2-20;this.addChild(b);this.tipLabel=new cc.LabelTTF("","Arial",46,cc.size(600,600),cc.TEXT_ALIGNMENT_LEFT);this.tipLabel.setAnchorPoint(0.5,1);this.tipLabel.x=a.width/2;this.tipLabel.y=a.height-this._shareLabel.getContentSize().height-50;this.addChild(this.tipLabel);b=new cc.MenuItemImage(res.JiXuBtn_png,res.JiXuBtn_png,function(){window.location.href=linkHref/*cc.director.runScene(new GameScene);cc.director.resume()*/},this);b.attr({x:a.width/2,y:a.height/5+60,anchorX:0.5,anchorY:0.5});var c=new cc.MenuItemSprite(new cc.Sprite(res.MoreGame_png),new cc.Sprite(res.MoreGame_png),function(){console.log(2);top.window.location.href='http://wx.1758.com';},this);c.attr({x:a.width/2,y:a.height/2-120,anchorX:0.5,anchorY:0.5});a=new cc.Menu(b,c);a.x=0;a.y=0;this.addChild(a)},showScore:function(a){cc.director.getVisibleSize();parseFloat(a/game_max_score).toFixed(2);var b="\u6211\u771f\u662f\u592a\u5389\u5bb3\uff0c\u5728\u516d\u89d2\u62fc\u62fc\u4e2d\u7adf\u7136\u5f97\u4e860\u5206\uff0c\u5168\u7403\u53ea\u67091\u4e2a\u4eba\u5f970\u5206\uff0c\u90a3\u4e2a\u4eba\u5c31\u662f\u6211\u5440\uff01";a>=game_max_score?b="\u6211\u5728\u516d\u89d2\u62fc\u62fc\u4e2d\u5f97\u4e86"+a+"\u5206\uff0c\u51fb\u8d25\u4e86\u5168\u7403\u6240\u6709\u5bf9\u624b\uff0c\u7b49\u4f60\u6765\u6218\uff01":0<a&&150>=a?b="\u6211\u5728\u516d\u89d2\u62fc\u62fc\u4e2d\u5f97\u4e86"+
...
2E3)/(game_max_score-2E3)),b="\u6211\u5728\u516d\u89d2\u62fc\u62fc\u4e2d\u5f97\u4e86"+a+"\u5206\uff0c\u636e\u8bf4\u5168\u7403\u53ea\u6709 "+b+"\u4e2a\u4eba\u8fbe\u5230\u8fd9\u4e2a\u6c34\u5e73\uff01\u6709\u4f60\u5417\uff1f");a>=game_max_score&&(game_max_score=a);hlmySetScore(a);/*updateShare(b);Play68.setRankingScoreDesc(a);*/this.tipLabel.string=b;},SetMaxScore:function(a){}});var GameInfoLayer=cc.LayerColor.extend({ctor:function(){this._super();this.init()},init:function(){this._super(cc.color(0,0,0,180));var a=cc.director.getVisibleSize();cc.p(a.width/2,a.height/2);var b,c;ChineseFlag?(b="\u70b9\u51fb\u4e0b\u9762\u65b9\u5757\u53ef\u8fdb\u884c\u65cb\u8f6c\uff0c\u53ef\u5c06\u65b9\u5757\u62d6\u5165\u4e0a\u65b9\u7a7a\u767d\u5904\uff0c\u5f53\u5468\u56f4\u8fde\u63a53\u4e2a\u540c\u8272\uff08\u540c\u70b9\u6570\uff09\u65f6\uff0c\u53ef\u4ee5\u8fdb\u884c\u6d88\u9664\u5408\u5e76\u3002",c="\u70b9\u51fb\u5f00\u59cb"):(b="Click on the following squares can rotate, can be square above into a blank space, when connecting three the same color, can be eliminated to merge.",c="Start");b=new cc.LabelTTF(b,"Arial",42,cc.size(600,450),cc.TEXT_ALIGNMENT_LEFT);b.setAnchorPoint(0.5,1);b.x=a.width/2;b.y=3*a.height/4;this.addChild(b);c=new cc.LabelTTF(c,"Arial",60);c.x=a.width/2;c.y=a.height/5;this.addChild(c);a=cc.EventListener.create({event:cc.EventListener.TOUCH_ONE_BY_ONE,onTouchBegan:this.onTouchBegin,onTouchMoved:this.onTouchMoved,onTouchEnded:this.onTouchEnded});cc.eventManager.addListener(a,this)},onTouchBegin:function(a,b){var c=b.getCurrentTarget();cc.director.resume();c.parent.gameStart();c.removeFromParentAndCleanup();return!1},onTouchMoved:function(a,b){},onTouchEnded:function(a,b){}});var hexcase=0,b64pad="",chrsz=8;function hex_md5(a){return binl2hex(core_md5(str2binl(a),a.length*chrsz))}
...
function core_hmac_md5(a,b){var c=str2binl(a);16<c.length&&(c=core_md5(c,a.length*chrsz));for(var d=Array(16),e=Array(16),f=0;16>f;f++)d[f]=c[f]^909522486,e[f]=c[f]^1549556828;c=core_md5(d.concat(str2binl(b)),512+b.length*chrsz);return core_md5(e.concat(c),640)}
function safe_add(a,b){var c=(a&65535)+(b&65535);return(a>>16)+(b>>16)+(c>>16)<<16|c&65535}
function bit_rol(a,b){return a<<b|a>>>32-b}
function str2binl(a){for(var b=[],c=(1<<chrsz)-1,d=0;d<a.length*chrsz;d+=chrsz)b[d>>5]|=(a.charCodeAt(d/chrsz)&c)<<d%32;return b}
function binl2str(a){for(var b="",c=(1<<chrsz)-1,d=0;d<32*a.length;d+=chrsz)b+=String.fromCharCode(a[d>>5]>>>d%32&c);return b}
function binl2hex(a){for(var b=hexcase?"0123456789ABCDEF":"0123456789abcdef",c="",d=0;d<4*a.length;d++)c+=b.charAt(a[d>>2]>>d%4*8+4&15)+b.charAt(a[d>>2]>>d%4*8&15);return c}
function binl2b64(a){for(var b="",c=0;c<4*a.length;c+=3)
for(var d=(a[c>>2]>>c%4*8&255)<<16|(a[c+1>>2]>>(c+1)%4*8&255)<<8|a[c+2>>2]>>(c+2)%4*8&255,e=0;4>e;e++)b=8*c+6*e>32*a.length?b+b64pad:b+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(d>>6*(3-e)&63);return b};var PC_FLAG=!1,ChineseFlag=!0;cc.game.onStart=function(){!cc.sys.isNative&&document.getElementById("cocosLoading")&&document.body.removeChild(document.getElementById("cocosLoading"));cc.view.enableRetina(cc.sys.os===cc.sys.OS_IOS?!0:!1);cc.view.adjustViewPort(!0);cc.sys.os===cc.sys.OS_IOS||cc.sys.os===cc.sys.OS_ANDROID||cc.sys.os===cc.sys.OS_BLACKBERRY||cc.sys.os===cc.sys.OS_WP8||cc.sys.os===cc.sys.OS_BADA?cc.view.setDesignResolutionSize(720,1280,cc.ResolutionPolicy.FIXED_WIDTH):(PC_FLAG=!0,cc.view.setDesignResolutionSize(720,1280,cc.ResolutionPolicy.SHOW_ALL));cc.sys.language==cc.sys.LANGUAGE_CHINESE&&(ChineseFlag=!0);document.getElementById("loadingImg")&&document.body.removeChild(document.getElementById("loadingImg"));cc.view.resizeWithBrowserSize(!0);cc._loaderImage="";cc.LoaderScene.preload(g_resources,function(){cc.director.runScene(new GameScene)},this)};
cc.game.run("J_gameContainer");
