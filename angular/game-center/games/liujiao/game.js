    ...
    f._handleItem = function() {
        ...
        if (!(0 === a._pool.length || a._workingSize >= a._limit)) {
            ...
            a._iterator.call(a._iteratorTarget, c, d, function(b) {
                if (!a._isErr) if (a.finishedSize++, a._workingSize--, b) a._isErr = !0, a._onEnd && a._onEnd.call(a._onEndTarget, b);
                else {
...
cc._fontLoader = {
    ...
    _loadFont: function(a, b, c) {
        ...
        if (b instanceof Array) for (var k = 0, m = b.length; k < m; k++) c = e.extname(b[k]).toLowerCase(), h += "url('" + b[k] + "') format('" + f[c] + "')", h += k === m - 1 ? ";" : ",";
...
cc.EGLView = cc.Class.extend({
    ...
    setDesignResolutionSize: function(a, b, c) {
        if (0 < a || 0 < b) if (this.setResolutionPolicy(c),
...
cc.eventManager = {
    ...
    _updateDirtyFlagForSceneGraph: function() {
        if (0 !== this._dirtyNodes.length) {
            ...
            if (b = d[a[e].__instanceId]) for (var g = 0, h = b.length; g < h; g++)(c = b[g]) && this._setDirty(c._getListenerID(), this.DIRTY_SCENE_GRAPH_PRIORITY);
    ...
    _dispatchEventToListeners: function(a, b, c) {
        var d = !1,
            ...
            g = 0,
            h;
        if (e && 0 !== e.length) for (; g < a.gt0Index; ++g)
    ...
    removeListener: function(a) {
        if (null != a) {
            ...
            if (!b) for (c = this._toAddedListeners, d = 0, e = c.length; d < e; d++)
            if (f = c[d], f === a) {
...
cc.Node = cc.Class.extend({
    ...
    doEnumerate: function(a, b) {
        ...
        if (f = g[k], - 1 !== f._name.indexOf(d)) if (e) {
...
(function() {
    ...
    a.transform = function(a, c) {
        ...
        if (c && (d = this._node._children) && 0 !== d.length) for (e = 0, f = d.length; e < f; e++) d[e]._renderCmd.transform(this, c)
    };
...
(function() {
    ...
    a.transform = function(a, c) {
        ...
        if (c && f._children && 0 !== f._children.length) for (f = f._children, d = 0, e = f.length; d < e; d++) f[d]._renderCmd.transform(this, c)
    };
    a.setShaderProgram = function(a) {
...
cc._tmp.WebGLTexture2D = function() {
    cc.Texture2D = cc.Class.extend({
        ...
        _initPremultipliedATextureWithImage: function(a, b, c) {
            ...
            if (g && k === d.PIXEL_FORMAT_RGB888) for (f = a.getData(), e = new Uint8Array(b * c * 3), m = 0; m < n; ++m) e[3 * m] = f >> 0 & 255, e[3 * m + 1] = f >> 8 & 255, e[3 * m + 2] = f >> 16 & 255;
...
cc.LoaderScene = cc.Scene.extend({
    ...
    init: function() {
        var a = this,
            b = 200,
            c = a._bgLayer = new cc.LayerColor(cc.color(255, 255, 255, 255));
        a.addChild(c, 0);
        var d = 24,
            e = -b / 2 + 100;
...
(function() {
    ...
    a._updateColor = function() {
        ...
        if (a._colorStops) for (this._endOpacity = this._startOpacity = 0, this._colorStopsStr = [], d = 0; d < a._colorStops.length; d++) c = a._colorStops[d].color, e = null == c.a ? 1 : c.a / 255, this._colorStopsStr.push("rgba(" + Math.round(c.r) + "," + Math.round(c.g) + "," + Math.round(c.b) + "," + e.toFixed(4) + ")")
    }
})();
(function() {
...
cc.SpriteBatchNode = cc.Node.extend({
    ...
    addSpriteWithoutQuad: function(a, b, c) {
        ...
        if (f && 0 < f.length) for (d = 0, e = f.length; d < e; d++) {
            var g = f[d];
    ...
    insertChild: function(a, b) {
        ...
        var d = a.children,
            e, f;
        if (d) for (c = 0, f = d.length || 0; c < f; c++)
        if (e = d[c]) {
    ...
    _createSpriteFrames: function(a, b, c) {
        ...
        for (var e in d) {
            ...
            if (!g) {
                ...
                if (f = f.aliases) for (var h = 0, k = f.length; h < k; h++) {
                    var m = f[h];
...
cc.Scheduler = cc.Class.extend({
    ...
    schedule: function(a, b, c, d, e, f, g) {
        ...
        } else for (p = 0; p < m.timers.length; ++p)
...
(function() {
    ...
    a._updateTTF = function() {
        ...
        this._isMultiLine = !1;
        this._measureConfig();
        if (0 !== c) for (this._strings = a._string.split("\n"), d = 0; d < this._strings.length; d++) this._checkWarp(this._strings, d, c);
    ...
    a._drawTTFInCanvas = function(a) {
        if (a) {
            ...
            if (this._isMultiLine) for (c = this._strings.length, g === cc.VERTICAL_TEXT_ALIGNMENT_BOTTOM ? m = d - 2 * k + f - d * c : g === cc.VERTICAL_TEXT_ALIGNMENT_CENTER && (m = (d - 2 * k) / 2 + (f - d * c) / 2), g = 0; g < c; g++) h = this._strings[g], p = -f + (d * g + k) + m, n && a.strokeText(h, e, p), a.fillText(h, e, p);
            else g !== cc.VERTICAL_TEXT_ALIGNMENT_BOTTOM && (m = g === cc.VERTICAL_TEXT_ALIGNMENT_TOP ? m - f : m - 0.5 * f), n && a.strokeText(c._string, e, m), a.fillText(c._string, e, m)
        }
    };
...
(function(a) {
    ...
    a.math.Matrix4._gaussj = function(a, b) {
        ...
        for (c = 0; 4 > c; c++) {
            for (m = s = 0; 4 > m; m++)
            if (1 !== t[m]) for (n = 0; 4 > n; n++) 0 === t[n] && (p = Math.abs(a.get(m, n)), p >= s && (s = p, k = m, d = n));
            ++t[d];
            if (k !== d) {
        ...
        for (m = 3; 0 <= m; m--)
        if (u[m] !== r[m]) for (n = 0; 4 > n; n++) a.swap(n, u[m], n, r[m]);
        return !0
    };
...
(function(a) {
    ...
    a.math.Quaternion.rotationBetweenVec3 = function(b, d, e) {
        ...
        if (1 <= h) return d.identity(), d; - 0.999999 > h ? Math.abs(e.lengthSq()) < a.math.EPSILON ? d.rotationAxis(e, Math.PI) : (f = new a.math.Vec3(1, 0, 0), f.cross(b), Math.abs(f.lengthSq()) < a.math.EPSILON && (f.fill(0, 1, 0), f.cross(b)), f.normalize(), d.rotationAxis(f, Math.PI)) : (b = Math.sqrt(2 * (1 + h)), e = 1 / b, f.cross(g), d.x = f.x * e, d.y = f.y * e, d.z = f.z * e, d.w = 0.5 * b, d.normalize());
        return d
    };
...
(function() {
    ...
    a.updateAtlasValues = function() {
        ...
        for (var m = e.quads, n = this._displayedColor, n = {
            ...
            var r = c.charCodeAt(s) - a._mapStartChar.charCodeAt(0),
                u = r % a._itemsPerRow,
                t = 0 | r / a._itemsPerRow,
                v;
...
cc.LabelBMFont = cc.SpriteBatchNode.extend({
    ...
    createFontChars: function() {
        ...
        if (0 !== g) {
            ...
            var s = n * e,
                ...
                r = -1;
            for (h = 0; h < g; h++)
            if (n = f.charCodeAt(h), 0 !== n) if (10 === n) b = 0, e -= k.commonHeight;
            else {
                var u = m[r << 16 | n & 65535] || 0,
                    t = p[n];
                if (t) {
    ...
    updateLabel: function() {
        ...
        if (this._alignment !== cc.TEXT_ALIGNMENT_LEFT) for (d = a = 0, e = this._string.length, f = [], g = 0; g < e; g++)
        if (10 === this._string[g].charCodeAt(0) || 0 === this._string[g].charCodeAt(0)) {
            ...
            if (0 === h) d++;
                ...
                if (null != k) {
                    ...
                    if (0 !== k) for (b = 0; b < h; b++) c = a + b + d, 0 > c || (c = this.getChildByTag(c)) && (c.x += k);
                    a += h;
                    d++;
                    f.length = 0
                }
...
cc._fntLoader = {
    ...
    parseFnt: function(a, b) {
        ...
        f = c.kerningDict = {};
        if (g = a.match(this.KERNING_EXP)) for (d = 0, e = g.length; d < e; d++) h = this._parseStrToObj(g[d]), f[h.first << 16 | h.second & 65535] = h.amount;
        return c
    },
    load: function(a, b, c, d) {
        var e = this;
...
cc.Menu = cc.Layer.extend({
    ...
    alignItemsInRows: function() {
        ...
        if (r && 0 < r.length) for (b = 0, p = r.length; b < p; b++)(n = r[b], g >= a.length || !(m = a[g])) || (s = n.width, h = h >= s || isNaN(s) ? h : s, f += n.height + 5, ++k, k >= m && (c.push(h), d.push(f), e += h + 10, h = k = 0, f = -5, ++g));
        f = cc.director.getWinSize();
        m = h = g = 0;
        var e = -e / 2,
            u = 0;
        if (r && 0 < r.length) for (b = 0, p = r.length; b < p; b++) n = r[b], 0 === m && (m = a[g], u = d[g]), s = n._getWidth(), h = h >= s || isNaN(s) ? h : s, n.setPosition(e + c[g] / 2, u - f.height / 2), u -= n.height + 10, ++k, k >= m && (e += h + 5, h = m = k = 0, ++g)
    },
    removeChild: function(a, b) {
...
(function() {
    ...
    if (c) switch (a.browserType) {
        case a.BROWSER_TYPE_CHROME:
            30 > parseInt(c) && (b[a.BROWSER_TYPE_CHROME] = {
                multichannel: !1,
                webAudio: !0,
                auto: !1
            });
...
cc.Audio = cc.Class.extend({
    ...
    _playOfWebAudio: function(a) {
        ...
        if (this._buffer) {
            if (!this._pause && b) if (0 === this._context.currentTime || this._currentTime + this._context.currentTime - this._startTime > this._currentSource.buffer.duration) this._stopOfWebAudio();
            else return;
...
var GameLayer = cc.Layer.extend({
    ...
    showGameInfo: function() {
        if (GameStartFlag) this.gameStart();
        else {
            GameStartFlag = !0;
            cc.director.pause();
    ...
    initScore: function() {
        ...
        a.attr({
            x: this.size.width / 2,
            y: this.circle.y + this.circle.height / 2 + 10,
            anchorX: 0.5,
            anchorY: 0
        });
        this.scoreTf = a
    ...
    showScore: function(a, b) {
        var c = a.getPosition(),
            d = new cc.LabelTTF("+" + b.toString(), null, 60);
        d.setPosition(c);
    ...
    checkGameEnd: function() {
        ...
        for (g in d) {
            var h = d[g],
                k;
            for (k in h)
            if (h[k].building || (e = g, f = k, c["4"] || (c["4"] = !0, b.push(4)), targetLogicX = (Number(e) + 1).toString(), targetLogicY = (Number(f) + 1).toString(), a("1"), targetLogicX = (Number(e) - 1).toString(), targetLogicY = (Number(f) - 1).toString(), a("1"), targetLogicX = (Number(e) - 2).toString(), targetLogicY = f.toString(), a("2"), targetLogicX = (Number(e) + 2).toString(), targetLogicY = (Number(f) + 0).toString(), a("2"), targetLogicX = (Number(e) - 1).toString(), targetLogicY = (Number(f) + 1).toString(), a("3"), targetLogicX = (Number(e) + 1).toString(), targetLogicY = (Number(f) - 1).toString(), a("3")), 4 <= b.length) break;
            if (4 <= b.length) break
        }
        for (g in d)
        for (k in h = d[g], h) h[k].checkEndFlag = !1;
        if (0 >= b.length) this.gameEnd();
        else {
            var m;
    ...
    pointToTile: function(a) {
        var b = this.itemDisY,
            c = Math.round((a.x - this.centerP.x) / (this.itemDisX / 2));
    ...
    checkCanPop: function() {
        ...
        if (0 < this.popTotalArr.length) for (c = 0; c < this.popTotalArr.length; c++) {
            b = this.popTotalArr[c];
            b.sort(function(a, b) {
                return b.moveSpeed - a.moveSpeed
            });
            for (var e = 0; e < b.length; e++)
            if (d = b[e], d.setLocalZOrder(2 + e), 0 < d.moveSpeed) {
                var f = this.SPEED_LEN / d.moveSpeed,
                    g = this.tileToPoint(d.moveTarget.logicX, d.moveTarget.logicY),
                    f = cc.sequence(cc.moveTo(f, g), cc.callFunc(function(b, c) {
                        if (b.moveTarget.moveTarget) {
                            var d = this.tileToPoint(b.moveTarget.moveTarget.logicX, b.moveTarget.moveTarget.logicY),
                                d = cc.sequence(cc.moveTo(this.SPEED_LEN / b.moveSpeed, d), cc.callFunc(function(b, c) {
                                    a(b, c)
                                }, c, c));
                            b.runAction(d)
                        } else a(b, c)
    ...
    addShadowAnimation: function(a) {
        var b = a.getPosition(),
            c = a.moveTarget.getPosition(),
            c = MyUtil.getAngleByPoints(b, c),
            b = new cc.Sprite("res/shadow/" + a.colorId + ".png");
        this.addChild(b);
        b.x = a.x;
        b.y = a.y;
        c *= -1;
    ...
    bombStart: function() {
        ...
        a();
        b(0, d[0]);
        if (0 < d.length) for (f = 1; f < d.length; f++) b(0.12, d[f]);
    ...
    addItemPoint: function(a) {
        var b = Number(a.colorId) + 1,
            c = b.toString();
        SoundUtile.playMusic("res/music/in");
        if (8 <= b) this.bombItem = a;
        else {
    ...
    checkOneItemCanPop: function(a) {
        ...
        if (!a.checkedFlag) {
            ...
            g = (Number(d) - 1).toString();
            b();
            if (0 < k.length) for (a = 0; a < k.length; a++) this.checkOneItemCanPop(k[a])
        }
    },
    ...
    gameEnd: function() {
        ...
        a.attr({
            x: this.size.width / 2,
            y: this.size.height / 2 - 20 + this.bottomEdgeY,
            opacity: 0
        });
    ...
    setGameScore: function() {
        var a = this.score,
            b = cc.sys.localStorage.getItem("p79_score");
        b || (b = a);
        a > b;
...
var EndLayer = cc.Layer.extend({
    ...
    showScore: function(a) {
        var b = cc.director.getVisibleSize(),
            c = new cc.Sprite(res.ScoreBg_png);
        this.addChild(c);
        c.attr({
            x: b.width / 2,
            y: 3 * b.height / 4 + 45
    ...
    SetMaxScore: function(a) {
        var b = cc.director.getVisibleSize(),
            c = new cc.LabelTTF("\u6700\u9ad8\u6210\u7ee9\uff1a" + a + "\u5206", "Arial", 45);
        this.addChild(c);
        c.attr({
            x: b.width / 2,
            y: 2 * b.height / 3 - 15
        });
        console.log("\u516d\u89d2\u62fc\u62fc\uff5e\u6211\u7684\u6700\u597d\u6210\u7ee9\uff1a" + a + "\u5206\uff0c\u6765\u8bd5\u4e00\u4e0b\uff1f")
    },
...
var EndLayerEnglish = cc.Layer.extend({
    ...
    ctor: function() {
        ...
        this.addChild(this.tipLabel);
        var b = a.height / 2 - 200 + AD_REAL_H,
            c = new cc.MenuItemImage(res.IconGame_png, res.IconGame_png, function() {
...
var GameEndLayer2 = cc.Layer.extend({
    ...
    ctor: function() {
        this._super();
        var a = cc.director.getVisibleSize(),
            b = new cc.LayerColor(cc.color(0, 0, 0, 230));
        this.addChild(b);
        ...
        this.addChild(this.tipLabel);
        b = new cc.MenuItemImage(res.JiXuBtn_png, res.JiXuBtn_png, function() {
            cc.director.runScene(new GameScene);cc.director.resume()
        }, this);
        b.attr({
            x: a.width / 2,
            y: a.height / 5 + 60,
        ...
        var c = new cc.MenuItemSprite(new cc.Sprite(res.MoreGame_png), new cc.Sprite(res.MoreGame_png), function() {
            console.log(2);
            top.window.location.href = 'http://wx.1758.com';
        }, this);
        c.attr({
            x: a.width / 2,
            y: a.height / 2 - 120,
    ...
    showScore: function(a) {
        ...
        a >= game_max_score ? b = "\u6211\u5728\u516d\u89d2\u62fc\u62fc\u4e2d\u5f97\u4e86" + a + "\u5206\uff0c\u51fb\u8d25\u4e86\u5168\u7403\u6240\u6709\u5bf9\u624b\uff0c\u7b49\u4f60\u6765\u6218\uff01" : 0 < a && 150 >= a ? b = "\u6211\u5728\u516d\u89d2\u62fc\u62fc\u4e2d\u5f97\u4e86" + a + "\u5206\uff0c\u771f\u662f\u592a\u68d2\u4e86\uff0c\u518d\u7ec3\u7ec3\u5c31\u8fbe\u5230\u719f\u80fd\u751f\u5de7\uff01" : 150 < a && 500 >= a ? b = "\u6211\u5728\u516d\u89d2\u62fc\u62fc\u4e2d\u5f97\u4e86" + a + "\u5206\uff0c\u771f\u662f\u592a\u68d2\u4e86\uff0c\u518d\u7ec3\u7ec3\u5c31\u662f\u7089\u706b\u7eaf\u9752\u5566\uff01" : 500 < a && 750 >= a ? b = "\u6211\u5728\u516d\u89d2\u62fc\u62fc\u4e2d\u5f97\u4e86" + a + "\u5206\uff0c\u51fb\u8d25\u4e86\u5168\u7403" + (Math.floor(12 * (a - 500) / 250) + 80) + "%\u7684\u73a9\u5bb6\uff0c\u8fbe\u5230\u4e86\u7089\u706b\u7eaf\u9752\u7684\u5883\u754c\uff01" : 750 < a && 1250 >= a ? b = "\u6211\u5728\u516d\u89d2\u62fc\u62fc\u4e2d\u5f97\u4e86" + a + "\u5206\uff0c\u51fb\u8d25\u4e86\u5168\u7403" + (Math.floor(7 * (a - 750) / 500) + 92) + "%\u7684\u73a9\u5bb6\uff0c\u8fbe\u5230\u4e86\u51fa\u795e\u5165\u5316\u7684\u5883\u754c!" : 1250 < a && 2E3 >= a ? b = "\u6211\u5728\u516d\u89d2\u62fc\u62fc\u4e2d\u5f97\u4e86" + a + "\u5206\uff0c\u51fb\u8d25\u4e86\u5168\u740399%\u7684\u73a9\u5bb6\uff0c\u8fbe\u5230\u4e86\u72ec\u5b64\u6c42\u8d25\u7684\u5883\u754c\uff01" : 2E3 < a && a < game_max_score && (b = 20 - Math.ceil(17 * (a - 2E3) / (game_max_score - 2E3)), b = "\u6211\u5728\u516d\u89d2\u62fc\u62fc\u4e2d\u5f97\u4e86" + a + "\u5206\uff0c\u636e\u8bf4\u5168\u7403\u53ea\u6709 " + b + "\u4e2a\u4eba\u8fbe\u5230\u8fd9\u4e2a\u6c34\u5e73\uff01\u6709\u4f60\u5417\uff1f");
        a >= game_max_score && (game_max_score = a);
        hlmySetScore(a); /*updateShare(b);Play68.setRankingScoreDesc(a);*/
